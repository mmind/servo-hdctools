...
inas = [(0x40, 'vdd_mux', 11.1, 0.01, 'rem', True),
        (0x41, '5v_sys', 5, 0.003, 'rem', True),
        (0x42, '3_3v_sys', 3.3, 0.01, 'rem', True),
        (0x44, '1_8v_vddio', 1.8, 0.01, 'rem', True),
        (0x45, '5v_core', 5, 0.02, 'rem', True),
        (0x46, '5v_cpu', 5, 0.02, 'rem', True),
        (0x48, 'vddio_ddr_ap', 1.35, 0.01, 'rem', True),
        (0x49, 'vddio_dram', 1.35, 0.01, 'rem', True),
        (0x4A, 'vdd_lcd_bl', 11.1, 0.02, 'rem', True),
        (0x4B, '3_3v_panel', 3.3, 0.02, 'rem', True),
        (0x4C, '5v_gpu', 5, 0.02, 'rem', True),
        (0x4D, '1_8v_vdd_wf', 1.8, 0.05, 'rem', True),
        (0x4E, '3_3v_vdd_wf', 3.3, 0.02, 'rem', True),
