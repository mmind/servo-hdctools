...
inas = [
        ...
        (0x43, 'pp1500_ap_io',   1.5, 0.01, 'loc', True),
        (0x44, 'pp3300_alw',     3.3, 0.01, 'loc', True),
        (0x45, 'ppvar_litcpu',   0.9, 0.01, 'loc', True),
        (0x46, 'pp1800_s0',      1.8, 0.01, 'loc', True),
        (0x47, 'pp3300_haven',   3.3, 0.10, 'loc', True),
